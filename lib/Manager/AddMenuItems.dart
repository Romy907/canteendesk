              ...
              if (!_isLoading)
                TextButton.icon(
                  ...
                  label: const Text(
                    ...
                    begin: const Offset(20, 0), curve: Curves.easeOutQuad),
            ],
          ),
          body: _isLoading
              ? Center(
                      ...
                      SafeArea(
                        child: Form(
                          ...
                          child: ListView(
                            ...
                            padding: EdgeInsets.fromLTRB(isDesktop ? 50 : 16, 8,
                                isDesktop ? 50 : 16, 32),
                            children: [
                              // Image picker card
  ...
  Widget _buildPriceField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        errorBorder: _errorBorder,
        prefixIcon:
            Icon(CupertinoIcons.money_rubl_circle_fill, color: _accentColor),
        floatingLabelStyle:
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon:
                            Icon(CupertinoIcons.percent, color: _discountColor),
                        suffixText: '%',
                        floatingLabelStyle: TextStyle(
                            color: _discountColor, fontWeight: FontWeight.bold),
      ...
      child: Row(
        children: [
          Container(
            ...
            child:
                Icon(CupertinoIcons.money_dollar_circle, color: _discountColor),
          ),
          const SizedBox(width: 16),
          Expanded(
            child: Column(
